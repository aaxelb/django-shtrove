...
class TestResourceIdentifier(TestCase):
    ...
    def test_scheme_equivalence_with_authority(self):
        self.assertEqual(
            self.identifier_foo.sufficiently_unique_iri, "://wibbleplop.example/la"
        )
        ...
        self.assertEqual(
            _identifier_foo.sufficiently_unique_iri, "://wibbleplop.example/la"
        )
        ...
        self.assertEqual(
            _identifier_bar.sufficiently_unique_iri, "://wibbleplop.example/la"
        )
        ...
        self.assertEqual(
            _identifier_http.sufficiently_unique_iri, "://wibbleplop.example/la"
        )
        ...
        self.assertEqual(
            _identifier_https.sufficiently_unique_iri, "://wibbleplop.example/la"
        )
        self.assertEqual(
            _identifier_https.scheme_list, ["foo", "bla", "bar", "http", "https"]
        )
    ...
    def test_find_equivalent(self):
        _cases_with_authority = [
            ...
            (
                "blarg:blerg",
                {
                    ...
                    "blarg:blerg": {
                        OWL.sameAs: {
                            "blip://blop.example/blep",
                            "bir://wibbleplop.example/la",
                        },
                    },
                },
            ),
        ...
        for _expected_equivalent, _tripledict in _cases_with_authority:
            self.assertEqual(
                self.identifier_foo.find_equivalent_iri(_tripledict),
                _expected_equivalent,
            )
