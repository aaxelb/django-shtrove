...
class TestOsfmapJsonDeriver(BaseIndexcardDeriverTest):
    ...
    expected_outputs = {
        ...
        "sharev2-with-subjects": {
            ...
            "dateCreated": [{"@value": "2019-01-23", "@type": "xsd:date"}],
            "creator": [
                {
                    ...
                    "sameAs": [{"@id": "http://osf.example/rando/"}],
                    "name": [{"@value": "Some Rando"}],
                    "affiliation": [
                        {
                            ...
                            "name": [{"@value": "Wassamatter University"}],
                        }
                    ],
                }
            ],
            "date": [{"@value": "2019-01-23", "@type": "xsd:date"}],
            "identifier": [{"@value": "http://osf.example/chair/"}],
            "isPartOf": [
                {
                    ...
                    "identifier": [{"@value": "http://osf.example/vroom/"}],
                    "isPartOf": [
                        {
                            ...
                            "identifier": [{"@value": "http://osf.example/mdept/"}],
                            "title": [{"@value": "Miscellaneous department"}],
                        }
                    ],
                    "title": [{"@value": "Various room"}],
                }
            ],
            "subject": [
                {"@value": "Architecture"},
            ...
            "conformsTo": [
                {
                    ...
                    "title": [{"@value": "Open-Ended Registration"}],
                }
            ],
            "dateCreated": [{"@value": "2021-10-18"}],
            "creator": [
                {
                    "@id": "https://osf.example/bhcjn",
                    "resourceType": [{"@id": "Agent"}, {"@id": "Person"}],
                    "identifier": [{"@value": "https://osf.example/bhcjn"}],
                    "name": [{"@value": "JW"}],
                    "affiliation": [
                        {
                            "@id": "https://ror.example/05d5mza29",
                            "resourceType": [{"@id": "Agent"}, {"@id": "Organization"}],
                            "identifier": [{"@value": "https://ror.example/05d5mza29"}],
                            "name": [{"@value": "Center For Open Science"}],
                        }
                    ],
                }
            ],
                    ...
                    "rights": [
                        {
                            ...
                            "name": [{"@value": "CC-By Attribution 4.0 International"}],
                        }
                    ],
                    "title": [{"@value": "IA/IMLS Demo: Child Component"}],
                    "sameAs": [{"@id": "https://doi.example/10.17605/OSF.IO/482N5"}],
                    "affiliation": [
                        {
                            "@id": "https://ror.example/05d5mza29",
                            "resourceType": [{"@id": "Agent"}, {"@id": "Organization"}],
            ...
            "isVersionOf": [
                {
                    ...
                    "identifier": [{"@value": "https://osf.example/hnm67"}],
                    "publisher": [
                        {
            ...
            "subject": [
                {
                    ...
                    "resourceType": [{"@id": "Concept"}],
                    "inScheme": [
                        {
                            "@id": "https://bepress.com/reference_guide_dc/disciplines/",
                            "resourceType": [{"@id": "Concept:Scheme"}],
                            "title": [
                                {
                    ...
                    "prefLabel": [{"@value": "Education"}],
                }
            ],
            "title": [{"@value": "IA/IMLS Demo"}],
            "sameAs": [{"@id": "https://doi.example/10.17605/OSF.IO/2C4ST"}],
            "accessService": [
                {
                    "@id": "https://osf.example",
                    "resourceType": [{"@id": "Agent"}, {"@id": "Organization"}],
            ...
            "osf:contains": [
                {
                    ...
                    "dateCreated": [{"@value": "2021-10-18"}],
                    "identifier": [{"@value": "https://osf.example/2ph9b"}],
                    "dateModified": [{"@value": "2021-10-18"}],
                    "fileName": [{"@value": "test_file.txt"}],
                    "filePath": [{"@value": "/Archive of OSF Storage/test_file.txt"}],
                    "isContainedBy": [{"@id": "https://osf.example/2c4st"}],
                }
            ],
            "hostingInstitution": [
                {
