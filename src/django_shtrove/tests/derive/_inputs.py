...
DERIVER_TEST_DOCS: dict[str, DeriverTestDoc] = {
    ...
    "sharev2-with-subjects": DeriverTestDoc(
        "http://osf.example/chair/",
        {
            "http://osf.example/chair/": {
                ...
                DCTERMS.conformsTo: {
                    rdf.blanknode(
                        {FOAF.name: {rdf.literal("Open-Ended Registration")}}
                    ),
                },
    ...
    "osfmap-registration": DeriverTestDoc(
        "https://osf.example/2c4st",
        {
            ...
            "https://bepress.com/reference_guide_dc/disciplines/": {
                ...
                DCTERMS.title: {
                    rdf.literal("bepress Digital Commons Three-Tiered Taxonomy")
                },
            },
            "https://cos.example/": {
                RDF.type: {DCTERMS.Agent, FOAF.Organization},
                DCTERMS.identifier: {
                    rdf.literal("https://cos.example/"),
                    rdf.literal("https://ror.example/05d5mza29"),
                },
            ...
            "https://osf.example/2c4st": {
                ...
                DCTERMS.description: {
                    rdf.literal(
                        "This registration tree is intended to demonstrate linkages between the OSF view of a Registration and the Internet Archive view"
                    )
                },
                DCTERMS.hasPart: {"https://osf.example/482n5"},
                DCTERMS.identifier: {
                    rdf.literal("https://doi.example/10.17605/OSF.IO/2C4ST"),
                    rdf.literal("https://osf.example/2c4st"),
                },
                ...
                OSFMAP.archivedAt: {
                    "https://archive.example/details/osf-registrations-2c4st-v1"
                },
            ...
            "https://osf.example/482n5": {
                ...
                DCTERMS.dateCopyrighted: {rdf.literal("2021")},
                DCTERMS.identifier: {
                    rdf.literal("https://doi.example/10.17605/OSF.IO/482N5"),
                    rdf.literal("https://osf.example/482n5"),
                },
                DCTERMS.publisher: {"https://osf.example/registries/osf"},
                DCTERMS.rights: {
                    "https://creativecommons.example/licenses/by/4.0/legalcode"
            ...
            "https://osf.example/registries/osf": {
                RDF.type: {DCTERMS.Agent, FOAF.Organization},
                DCTERMS.identifier: {
                    rdf.literal("https://osf.example/"),
                    rdf.literal("https://osf.io/registries/osf"),
                },
