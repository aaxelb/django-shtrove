    ...
    expected_outputs = {
        "simple_card": EntireRendering(
            ...
            entire_content=json.dumps(
                {
                    "@id": "blarg:aCard",
                    "dcterms:issued": [{"@type": "xsd:date", "@value": "2024-01-01"}],
                    "dcterms:modified": [{"@type": "xsd:date", "@value": "2024-01-01"}],
                    "foaf:primaryTopic": [{"@id": "blarg:anItem"}],
                    "rdf:type": [
                        {"@id": "trove:Indexcard"},
                        {"@id": "dcat:CatalogRecord"},
                    ],
                    "trove:focusIdentifier": [{"@value": BLARG.anItem}],
            ...
            entire_content=json.dumps(
                {
                    ...
                    "blarg:hasIntegerLiteral": [
                        {"@type": "xsd:integer", "@value": "17"}
                    ],
                    "blarg:hasIri": [{"@id": "blarg:anIri"}],
                    "blarg:hasRdfLangStringLiteral": [
                        {"@language": "en", "@value": "a rdf:langString literal"}
                    ],
                    "blarg:hasRdfStringLiteral": [{"@value": "an rdf:string literal"}],
    ...
    expected_outputs = {
        "no_results": EntireRendering(
            ...
            entire_content=json.dumps(
                {
                    "@id": "blarg:aSearch",
                    "rdf:type": [{"@id": "trove:Cardsearch"}],
                    "trove:totalResultCount": {"@type": "xsd:integer", "@value": "0"},
                }
            ),
        ),
            ...
            entire_content=json.dumps(
                {
                    "@id": "blarg:aSearchFew",
                    "rdf:type": [{"@id": "trove:Cardsearch"}],
                    "trove:totalResultCount": {"@type": "xsd:integer", "@value": "3"},
                    "trove:searchResultPage": [
                        {
                            "@list": [
                                {
                                    "rdf:type": [{"@id": "trove:SearchResult"}],
                                    "trove:indexCard": {
                                        "@id": "blarg:aCard",
                                        "dcterms:issued": [
                                            {
                                ...
                                },
                                {
                                    ...
                                    "trove:indexCard": {
                                        ...
                                        "foaf:primaryTopic": [{"@id": "blarg:anItemm"}],
                                        "rdf:type": [
                                            {"@id": "trove:Indexcard"},
                                            {"@id": "dcat:CatalogRecord"},
                                        ],
